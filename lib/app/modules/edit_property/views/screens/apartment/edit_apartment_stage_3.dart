...
import 'package:broker/app/modules/edit_property/views/widgets/add_property_image_edit.dart';
...
class EditApartmentStage3 extends GetView<EditApartmentController> {
  const EditApartmentStage3({super.key});
          ...
          children: [
            ...
            Obx(() {
              ...
              return OutlinedAppButton(
                onPressed:
                    controller.apiPhotosList.length < 6
                        ? () {
