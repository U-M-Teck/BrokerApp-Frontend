...
class AddApartmentStage5 extends GetView<AddApartmentController> {
  const AddApartmentStage5({super.key});
                ...
                Row(
                  ...
                  children: [
                    Expanded(
                      ...
                      items: {AppStrings.mr: 1, AppStrings.mrs: 2},
                    ...
                    Expanded(
                      child: TextFormField(
                        ...
                        initialValue: StorageService.getData("userName") ?? "",
                      ),
                    ),
                 ...
                 DropDownWidget(
                      items: {AppStrings.owner: 1, AppStrings.broker: 2},
